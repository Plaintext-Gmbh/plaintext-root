...
package ch.plaintext.notifications.config;
 ...
 */
@AutoConfiguration
@ComponentScan("ch.plaintext.notifications")
@EntityScan("ch.plaintext.notifications")
@EnableJpaRepositories("ch.plaintext.notifications")
