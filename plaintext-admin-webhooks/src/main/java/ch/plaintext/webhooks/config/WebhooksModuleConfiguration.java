...
package ch.plaintext.webhooks.config;
 ...
 */
@AutoConfiguration
@ComponentScan("ch.plaintext.webhooks")
@EntityScan("ch.plaintext.webhooks")
@EnableJpaRepositories("ch.plaintext.webhooks")
public class WebhooksModuleConfiguration {
}
