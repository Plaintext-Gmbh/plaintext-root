 ...
 * scan as an AutoConfiguration. The consumer still finds menu classes via
 * {@code plaintext.menu.scan-package} (comma-separated list).
 *
 * @since 1.508.0
 */
@AutoConfiguration
@ComponentScan("ch.plaintext.apitoken")
@EntityScan("ch.plaintext.apitoken")
@EnableJpaRepositories("ch.plaintext.apitoken")
public class ApiTokenModuleConfiguration {
}
