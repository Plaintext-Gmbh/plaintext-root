...
package ch.plaintext.modules.config;
 ...
 */
@AutoConfiguration
@ComponentScan("ch.plaintext.modules")
@EntityScan("ch.plaintext.modules")
@EnableJpaRepositories("ch.plaintext.modules")
public class ModulesModuleConfiguration {
}
