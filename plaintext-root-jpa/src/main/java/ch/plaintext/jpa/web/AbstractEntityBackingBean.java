 ...
 *
 * <p>The subclasses of this base are <b>session-scoped and serializable</b> and they inherit
 * these fields. On a deserialization <b>no constructor runs</b>: a service field set only
 * through the
