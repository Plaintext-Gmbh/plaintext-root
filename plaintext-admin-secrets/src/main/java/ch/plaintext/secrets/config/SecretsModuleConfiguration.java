...
package ch.plaintext.secrets.config;
 ...
 * scan as an AutoConfiguration. The consumer still finds menu classes
 * via {@code plaintext.menu.scan-package} (comma-separated list).
 *
 * @since 1.508.0
 */
@AutoConfiguration
@ComponentScan("ch.plaintext.secrets")
@EntityScan("ch.plaintext.secrets")
@EnableJpaRepositories("ch.plaintext.secrets")
public class SecretsModuleConfiguration {
}
